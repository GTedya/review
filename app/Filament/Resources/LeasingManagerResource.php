...
use App\Filament\Resources\LeasingManagerResource\RelationManagers;
use App\Models\LeasingManager;
use App\Models\User;
...
class LeasingManagerResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return $users->whereHas('roles', function ($query){
            $query->where('name', 'leasing_manager');
        });
    }
}
