...
class VehicleTypePolicy
{
    ...
    {
        return $user->can('view vehicle_types');
    }
    ...
    {
        return $user->can('create vehicle_types');
    }
    ...
    {
        return $user->can('edit vehicle_types');
    }
    ...
    {
        return $user->can('delete vehicle_types');
    }
    ...
    {
        return $user->can('force delete vehicle_types');
    }
}
